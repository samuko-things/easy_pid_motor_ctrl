...
public:
  ...
  bool sendOne(String cmd_route, float val){
  ...
  bool send(String cmd_route, float (&dataArr)[2]){
    
    String msg_buffer = cmd_route;
    msg_buffer += ",";
    msg_buffer += String(dataArr[0],3);
    msg_buffer += ",";
    msg_buffer += String(dataArr[1],2);
