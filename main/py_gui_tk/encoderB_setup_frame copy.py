...
class EncBSetupFrame(customtkinter.CTkFrame):
  def __init__(self, parent):
    ...
    # add set card frame
    self.setPwmCardFrame = SetDataCardFrame(self, "PPR_B", int(g.serClient.get("pprB")), placeHolderText="enter new PPR_B", set_func=setEncBppr)
    self.setPwmCardFrame.grid(row=1, column=0, padx=(20,10), pady=10)

    self.setPwmCardFrame = SetDataCardFrame(self, "PWM_B", g.ctrlPwmB, placeHolderText="enter new PWM_B", set_func=setPwmValB)
